...
output_data = 'Radiomic Features_Validation_Enhance_T1ce.xlsx';
...
%for row_data=1
    ...
    temp1 = int16(temp1);
    temp2 = V_t1ce(row_min:row_max, col_min:col_max, max_Enhan_slice);
...
%% Calculate GLCM features
    ...
    glcm_flair = graycomatrix(roi_t1ce,'NumLevels',9,'Offset',[0 1],'GrayLimits',[]);
   ...
   glcm_flair_ca = graycomatrix(roi_t1ce,'NumLevels',9,'Offset',[0 1],'GrayLimits',[]);
   GLCMFeatures_flair_ca = GLCMFeatures(glcm_flair_ca);  
   
   glcm_flair_chd = graycomatrix(roi_t1ce,'NumLevels',9,'Offset',[0 1],'GrayLimits',[]);
   GLCMFeatures_flair_chd = GLCMFeatures(glcm_flair_chd);  
   
   glcm_flair_cvd = graycomatrix(roi_t1ce,'NumLevels',9,'Offset',[0 1],'GrayLimits',[]);
   GLCMFeatures_flair_cvd = GLCMFeatures(glcm_flair_cvd);  
   
   glcm_flair_cdd = graycomatrix(roi_t1ce,'NumLevels',9,'Offset',[0 1],'GrayLimits',[]);
